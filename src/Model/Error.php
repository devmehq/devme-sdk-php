...
class Error implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets value
     *
     * @param AnyOfStringNumber|null $value error value
     *
     * @return self
     */
     ...
     * Sets param
     *
     * @param string|null $param error parameters
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location location of the error
     *
     * @return self
     */
