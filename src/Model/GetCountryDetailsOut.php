...
/**
 * GetCountryDetailsOut Class Doc Comment
 *
 * @category Class
 * @package  Devme
 * @author   DEV.ME Team
 ...
 */
class GetCountryDetailsOut implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetCountryDetailsOut';
     ...
     * Sets code
     *
     * @param string|null $code country code ISO 4217
     *
     * @return self
     */
