...
class GetPhoneDetailsOut implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetPhoneDetailsOut';
     ...
     * Sets valid
     *
     * @param bool|null $valid is phone number valid
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country country code associated with phone number ISO 3166-1 alpha-2
     *
     * @return self
     */
     ...
     * Sets calling_code
     *
     * @param string|null $calling_code country calling code associated with phone number
     *
     * @return self
     */
     ...
     *
     * @param string|null $national_number national number associated with phone number
     *
     * @return self
     */
